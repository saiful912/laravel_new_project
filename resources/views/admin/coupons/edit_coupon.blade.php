...
@section('content')
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Edit Coupon</a></div>
            <h1>Edit Coupon</h1>
        </div>
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="{{url('/admin/edit-coupon/'.$couponDetails->id)}}" name="add_coupon" id="add_coupon">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="amount_type" id="amount_type" style="width: 220px;" required>
                                            <option @if($couponDetails->amount_type=="Percentage") selected
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input @if($couponDetails->status=="1") checked @endif type="checkbox" name="status" id="status" value="1" >
                                    </div>
                                </div>
